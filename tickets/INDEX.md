...
| [T-152](T-152-lore-reel-store.md) | The reel store: blobs by sha-256, pointer resolution, peaks | T-151 | done |
...
| [T-157](T-157-lore-bake.md) | Bake: offline mixdown → WAV → `telling`; pack the reel | T-154 | done |
| [T-158](T-158-lore-sourcing.md) | Sourcing: file import, drag-drop, line-in | T-152, T-154 | done |
| [T-159](T-159-lore-telling-rewind.md) | The telling: told-time log + rewind you can listen to | T-154, T-156 | done |
| [T-160](T-160-lore-torture-polish.md) | Torture + polish: TESTING.md, honesty, smoke pass, deploy | T-153…T-159 | done |
