/**
 * What a link handed out of this room looks like (T-177, option 2 —
 ...
 * canonical relay a client redeploy rather than a stranded link. A room on
 * any other relay keeps carrying it: there the fallback would land its
 * people somewhere else (SPEC §1 — "the link, not the client, decides where
