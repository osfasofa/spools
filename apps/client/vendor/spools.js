...
${err.toString()}`);
  ...
  var deriveKey, encrypt, encryptJson, decrypt, decryptJson;
  var init_crypto = __esm({
    "../../node_modules/.pnpm/y-webrtc@10.3.0_yjs@13.6.32/node_modules/y-webrtc/src/crypto.js"() {
      ...
      decryptJson = (data, key) => decrypt(data, key).then(
  ...
  var init_y_webrtc = __esm({
    "../../node_modules/.pnpm/y-webrtc@10.3.0_yjs@13.6.32/node_modules/y-webrtc/src/y-webrtc.js"() {
      ...
      broadcastBcMessage = (room, m) => encrypt(m, room.key).then(
        (data) => room.mux(
...
${reason}`);
  ...
  var SpoolEngine = class {
    constructor(opts) {
      ...
      if (persist) {
        ...
        this.whenReady = idb.synced ? Promise.resolve() : new Promise((resolve2) => idb.once("synced", () => resolve2()));
      } else {
  ...
  var Spool = class {
    ...
    share(base) {
      return buildSpoolLink({ code: this.code, relay: __privateGet(this, _relay), key: __privateGet(this, _key), base });
    }
